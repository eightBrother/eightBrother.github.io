		...
		"initAudio" : function(){
			...
			this.append(
				'<div class="music_info clearfix">\
					<div style="position: absolute;filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5;"><img style="width:115px;height:125px;position: absolute;left:14px;"src="images/457B0254.jpg"/></div>\
					<div class="meta_data">\
			...
			$(".btn_next").click(function(){
				...
				currentSrc = $("#myAudio source")[currentSrcIndex].src;
