...
(this, function() {
            ...
            update: function(t) {
                ...
                if (e) {
                    ...
                    if (a.isSingleCanvas && a.isSingleCanvas())
                        ...
                        o = o,
                        this._dom.style.backgroundColor = o
                    }
                }
            },
    ...
    , function(t, e, i) {
            ...
            if (!t.__isHover) {
                if (t.__hoverStlDirty) {
                    var e = t.style.stroke
                      ...
                      , n = t.__hoverStl
                      , o = v.lift;
                    n.fill = n.fill || i && (i instanceof _ ? i : o(i, -.1)),
                    n.stroke = n.stroke || e && (e instanceof _ ? e : o(e, -.1));
                    var a = {};
                    for (var r in n)
                        n.hasOwnProperty(r) && (a[r] = t.style[r]);
                    t.__normalStl = a,
                    t.__hoverStlDirty = !1
                }
        ...
        function d(t, e, i, n, o) {
            ...
            n && n.getShallow("animation") ? e.animateTo(i, r, s, o) : (e.attr(i),
            o && o())
        }
        var f = i(1)
          , p = i(156)
        ...
        w.transformDirection = function(t, e, i) {
            ...
            return a = w.applyTransform(a, e, i),
    ...
    , function(t, e) {
        ...
        n.linearMap = function(t, e, i, n) {
            ...
            if (0 === o)
                return (i[0] + i[1]) / 2;
            var a = (t - e[0]) / o;
            return n && (a = Math.min(Math.max(a, 0), 1)),
            a * (i[1] - i[0]) + i[0]
        }
        ,
    ...
    , function(t, e, i) {
        ...
        a.prototype = {
            ...
            brush: function(t) {
                ...
                a && e.stroke instanceof u && e.stroke.updateCanvasGradient(this, t)),
                e.bind(t, this),
                this.setTransform(t);
                var s = e.lineDash
                  , l = e.lineDashOffset
                  , h = !!t.setLineDash;
                this.__dirtyPath || s && !h && a ? (i = this.path.beginPath(t),
                s && !h && (i.setLineDash(s),
            ...
            getBoundingRect: function() {
                ...
                if (o(e) && (this.__dirty || !this._rect)) {
                    ...
                    return n(e) || (r = Math.max(r, this.strokeContainThreshold)),
                    s > 1e-10 && (a.width += r / s,
                    a.height += r / s,
                    a.x -= r / s / 2,
                    a.y -= r / s / 2),
    ...
    , function(t, e, i) {
        ...
        l.createDataFormatModel = function(t, e, i) {
            var n = new r;
            return a.mixin(n, l.dataFormatMixin),
        ...
        l.converDataValue = function(t, e) {
            var i = e && e.type;
            return "ordinal" === i ? t : ("time" !== i || isFinite(t) || null  == t || "-" === t || (t = +o.parseDate(t)),
            null  == t || "" === t ? NaN : +t)
        }
        ,
        l.dataFormatMixin = {
            ...
            getFormattedLabel: function(t, e, i) {
                ...
                return null  == i && (i = a.get(["label", e, "formatter"])),
    ...
    , function(t, e, i) {
        ...
        u.getLayoutRect = function(t, e, i) {
            ...
            isNaN(f) && (f = o - c - p - h),
            isNaN(d) && isNaN(f) && (m > n / o ? d = .8 * n : f = .8 * o),
    ...
    , function(t, e, i) {
        ...
        n.prototype = {
            ...
            get: function(t, e) {
                ...
                for (var i = this.option, n = this.parentModel, o = 0; o < t.length && (i = i && "object" == typeof i ? i[t[o]] : null ,
                null  != i); o++)
                    ;
            ...
            getShallow: function(t, e) {
                var i = this.option
                  , n = i && i[t]
                  , o = this.parentModel;
                return null  == n && o && !e && (n = o.getShallow(t)),
                n
            },
        ...
        var n = i(1)
          ...
          , h = r.extend({
            ...
            mergeDefaultAndTheme: function(t, e) {
                ...
                a.defaultEmphasis(t.label, ["position", "show", "textStyle", "distance", "formatter"]);
                for (var i = t.data || [], o = 0; o < i.length; o++)
                    i[o] && i[o].label && a.defaultEmphasis(i[o].label, ["position", "show", "textStyle", "distance", "formatter"])
            },
    ...
    , function(t, e, i) {
        (function(e) {
            ...
            y.downSample = function(t, e, i, n) {
                for (var a = o(this, [t]), r = this._storage, s = a._storage, l = this.indices, h = a.indices = [], u = [], c = [], d = Math.floor(1 / e), f = s[t], p = this.count(), g = 0; g < r[t].length; g++)
                    s[t][g] = r[t][g];
                for (var g = 0; p > g; g += d) {
                    d > p - g && (d = p - g,
                    u.length = d);
    ...
    , function(t, e) {
        function i(t) {
            ...
            w && (i.edge = !0,
            i.version = w[1]),
            e.tablet = !!(a || g || o && !t.match(/Mobile/) || v && t.match(/Tablet/) || _ && !t.match(/Phone/) && t.match(/Touch/)),
            e.phone = !(e.tablet || e.ipod || !(o || s || l || d || f || m && t.match(/Android/) || m && t.match(/CriOS\/([\d.]+)/) || v && t.match(/Mobile/) || _ && t.match(/Touch/))),
            {
                browser: i,
                os: e,
                node: !1,
        ...
        function m(t, e) {
            if (!(2 !== t.length || t[1] < t[0])) {
                for (var i = g(t[0], e, !0), n = g(t[1], e, !0), o = [{
                    color: i.color,
                    offset: 0
                }], a = n.value - i.value, r = Math.max(i.value, i.rightIndex), s = Math.min(n.value, n.leftIndex), l = r; a > 0 && s >= l; l++)
                    o.push({
                        color: e[l],
                        offset: (l - i.value) / a
                    });
    ...
    , function(t, e, i) {
        ...
        h.niceScaleExtent = function(t, e) {
            ...
            i.setExtent(n[0], n[1]),
            i.niceExtent(e.get("splitNumber"), o, a);
        ...
        h.getFormattedLabels = function(t, e) {
            ...
            (e),
            s.map(n, e)) : "function" == typeof e ? s.map(o, function(n, o) {
    ...
    , function(t, e, i) {
        ...
        y.prototype = {
            ...
            bezierCurveTo: function(t, e, i, n, o, a) {
                return this.addData(s.C, t, e, i, n, o, a),
            ...
            arc: function(t, e, i, n, o, a) {
                return this.addData(s.A, t, e, i, i, n, o - n, 0, a ? 0 : 1),
            ...
            _dashedBezierTo: function(t, e, i, o, a, r) {
                ...
                f %= d,
                s = 0; 1 > s; s += .1)
                    l = x(v, t, i, a, s + .1) - x(v, t, i, a, s),
                    h = x(y, e, o, r, s + .1) - x(y, e, o, r, s),
                    _ += m(l * l + h * h);
                for (; b > w && (M += p[w],
                !(M > f)); w++)
                    ;
            ...
            getBoundingRect: function() {
                ...
                for (var t = this.data, e = 0, i = 0, n = 0, d = 0, f = 0; f < t.length; ) {
                    ...
                    case s.M:
                        ...
                        break;
                    case s.L:
                        a.fromLine(e, i, t[f], t[f + 1], u, c),
                        e = t[f++],
                        i = t[f++];
                        break;
                    case s.C:
                        a.fromCubic(e, i, t[f++], t[f++], t[f++], t[f++], t[f], t[f + 1], u, c),
                        e = t[f++],
                        i = t[f++];
                        break;
                    case s.Q:
                        a.fromQuadratic(e, i, t[f++], t[f++], t[f], t[f + 1], u, c),
                        e = t[f++],
                        i = t[f++];
                        break;
                    case s.A:
            ...
            rebuildPath: function(t) {
                for (var e = this.data, i = 0; i < this._len; ) {
                    ...
                    case s.A:
                        ...
                        t.scale(1 / p, 1 / g),
                        t.rotate(-c),
                        t.translate(-o, -a)) : t.arc(o, a, f, h, h + u, 1 - d);
                        break;
                    case s.R:
    ...
    , function(t, e, i) {
        ...
        function o(t, e) {
            ...
            if (o) {
                ...
                if (a) {
                    var r = n(t);
                    e.zrX = a.clientX - r.left,
                    e.zrY = a.clientY - r.top
                }
            } else {
                var s = n(t);
        ...
        s.updateData = function(t, e) {
            ...
            t.diff(r).add(function(n) {
                ...
                var u = r.getItemGraphicEl(h)
                  , c = t.getItemLayout(l);
                return o(t, l, e) ? (u ? (u.updateData(t, l),
                a.updateProps(u, {
                    position: c
                }, n)) : (u = new s(t,l),
                u.attr("position", c)),
                ...
                if (t.length) {
                    ...
                    for (n.each(t, function(t) {
                        ...
                        var d = u.pop()
                          , f = h[d]
                          , p = !!c[d];
                        p && (o.call(a, d, f.originalDeps.slice()),
                        delete c[d]),
    ...
    , function(t, e, i) {
        ...
        l.prototype = {
            ...
            getBands: function() {
                for (var t = this.getExtent(), e = [], i = this.scale.count(), n = t[0], o = t[1], a = o - n, r = 0; i > r; r++)
    ...
    , function(t, e, i) {
        ...
        u._updateCommon = function(t, e, i) {
            ...
            o.setColor(g),
            r.extend(o.style, u.getItemStyle(["color"]));
            for (var x, _ = s.getModel(f), w = s.getModel(p), b = o.style, M = t.dimensions.slice(), S = M.pop(); "ordinal" === (x = t.getDimensionInfo(S).type) || "time" === x; )
                S = M.pop();
            _.get("show") ? (l.setText(b, _, g),
            b.text = r.retrieve(a.getFormattedLabel(e, "normal"), t.get(S, e))) : b.text = "",
            w.getShallow("show") ? (l.setText(m, w, g),
            m.text = r.retrieve(a.getFormattedLabel(e, "emphasis"), t.get(S, e))) : m.text = "";
            var A = n(t.getItemVisual(e, "symbolSize"));
            if (o.off("mouseover").off("mouseout").off("emphasis").off("normal"),
            l.setHoverStyle(o, m),
    ...
    , function(t, e, i) {
        function n(t, e, i) {
            ...
            return u(a) ? (o = i > 0 ? "top" : "bottom",
            n = "center") : u(a - c) ? (o = i > 0 ? "bottom" : "top",
            n = "center") : (o = "middle",
            n = a > 0 && c > a ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"),
            {
                rotation: a,
                textAlign: n,
                verticalAlign: o
        ...
        function o(t, e, i) {
            ...
            return u(a - c / 2) ? (o = s ? "bottom" : "top",
            n = "center") : u(a - 1.5 * c) ? (o = s ? "top" : "bottom",
            n = "center") : (o = "middle",
            n = 1.5 * c > a && a > c / 2 ? s ? "left" : "right" : s ? "right" : "left"),
            {
                rotation: a,
                textAlign: n,
                verticalAlign: o
        ...
        var f = {
            ...
            axisName: function() {
                ...
                i) {
                    ...
                    a = "middle" === s ? n(t, t.rotation, l) : o(t, s, c),
          ...
          , p = d.ifIgnoreOnTick = function(t, e, i) {
            var n, o = t.scale;
            return "ordinal" === o.type && ("function" == typeof i ? (n = o.getTicks()[e],
            !i(n, o.getLabel(n))) : e % (i + 1))
        }
    ...
    , function(t, e, i) {
        ...
        g.resize = function(t, e) {
            ...
            i(),
            t.get("containLabel") && (d(a, function(t) {
                if (!t.model.get("axisLabel.inside")) {
                    ...
                    if (e) {
                        ...
                        n[i] -= e[i] + a,
                        "top" === t.position ? n.y += e.height + a : "left" === t.position && (n.x += e.width + a)
                    }
                }
            }
            ),
            ...
            function o(i) {
                return function(o, h) {
                    if (n(o, t, e)) {
                        ...
                        a[u] && (u = "top" === u ? "bottom" : "top")) : ("left" !== u && "right" !== u && (u = "left"),
    ...
    , function(t, e, i) {
        ...
        function r(t) {
            return {
                ...
                mapValueToVisual: function(t) {
                    ...
                    return null  == i && (i = u(this) ? h(this, o, e) : n(e, [0, 1], o, !0)),
                    i
                }
            }
        }
        ...
        v.mapVisual = function(t, e, i) {
            var n, o = c.isArray(t) ? [] : c.isObject(t) ? {} : (n = !0,
            null );
            ...
            for (var i = 0, n = e.length; n > i; i++) {
                ...
                if (a)
                    if (a[0] === -(1 / 0)) {
                        ...
                        if (a[0] < t)
                            return i
                    } else if (o.interval[0] <= t && t <= o.interval[1])
                        return i
            }
        }
        ,
    ...
    , function(t, e, i) {
        ...
        a.prototype = {
            ...
            updateCanvasGradient: function(t, e) {
                for (var i = t.getBoundingRect(), n = this.x * i.width + i.x, o = this.x2 * i.width + i.x, a = this.y * i.height + i.y, r = this.y2 * i.height + i.y, s = e.createLinearGradient(n, a, o, r), l = this.colorStops, h = 0; h < l.length; h++)
    ...
    , function(t, e, i) {
        ...
        h.decomposeTransform = function() {
            if (this.transform) {
                var t = this.parent
                  , e = this.transform;
                t && t.transform && (o.mul(u, t.invTransform, e),
                e = u);
            ...
            _updateStyle: function(t, e, i) {
                ...
                e.eachItemGraphicEl(function(r, s) {
                    ...
                    var f = i ? u.height > 0 ? "bottom" : "top" : u.width > 0 ? "left" : "right"
                      ...
                      , m = r.style;
                    p.get("show") ? n(m, p, h, o.retrieve(t.getFormattedLabel(s, "normal"), t.getRawValue(s)), f) : m.text = "",
                    g.get("show") ? n(d, g, h, o.retrieve(t.getFormattedLabel(s, "emphasis"), t.getRawValue(s)), f) : d.text = "",
                    a.setHoverStyle(r, d)
                }
                )
            },
    ...
    , function(t, e, i) {
        ...
        function s() {
            ...
            if (this.__dirty || e.__dirty) {
                ...
                c.normalize(h, h),
                i && (i.attr("position", a),
                r(i) && i.attr("rotation", l(s, a))),
                n && (n.attr("position", s),
                r(n) && n.attr("rotation", l(a, s))),
                o.attr("position", s);
                var u, d, f;
                "end" === o.__position ? (u = [5 * h[0] + s[0], 5 * h[1] + s[1]],
                d = h[0] > .8 ? "left" : h[0] < -.8 ? "right" : "center",
                f = h[1] > .8 ? "top" : h[1] < -.8 ? "bottom" : "middle") : (u = [5 * -h[0] + a[0], 5 * -h[1] + a[1]],
        ...
        var u = i(24)
          ...
          , m = h.prototype;
        m.beforeUpdate = s,
        m._createLine = function(t, e, i, a) {
            var r = t.hostModel
              , s = t.getItemLayout(a)
              , l = o(s);
            l.shape.percent = 0,
            ...
            e) {
                ...
                this.add(u),
                this._fromSymbolType = e.getItemVisual(a, "symbol")
            }
            if (i) {
                var c = n("toSymbol", i, a);
                this.add(c),
                this._toSymbolType = i.getItemVisual(a, "symbol")
            }
        ...
        m.updateLayout = function(t, e, i, n) {
            ...
            a(r.shape, o),
            r.dirty(!0),
            e && e.getItemGraphicEl(n).attr("position", o[0]),
            i && i.getItemGraphicEl(n).attr("position", o[1])
        }
        ,
    ...
    , function(t, e, i) {
        ...
        o.registerProcessor("statistic", n.curry(i(122), "line")),
        i(34)
    }
    , function(t, e, i) {
        "use strict";
    ...
    , function(t, e, i) {
        ...
        t.exports = y.extend({
            ...
            render: function(t, e, i) {
                ...
                M || m.remove(),
                r.add(x),
                v && g.type === a.type ? (w && !y ? y = this._newPolygon(f, b, a, _) : y && !w && (x.remove(y),
    ...
    , function(t, e, i) {
            ...
            for (var y = i, x = 0; o > x; x++) {
                ...
                if (y === i)
                    ...
                    var w = y - a
                      ...
                      , S = e[w]
                      , A = e[b];
                    if (a > 0 && (y === o - 1 || isNaN(A[0]) || isNaN(A[1])) || 0 >= a && (0 === y || isNaN(A[0]) || isNaN(A[1])))
                        u(f, _);
                    else {
        ...
        t.exports = {
            Polyline: a.extend({
                ...
                buildPath: function(t, e) {
                    for (var i = e.points, a = 0, r = i.length, s = o(i, e.smoothConstraint); r > a; )
                        a += n(t, i, a, r, r, 1, s.min, s.max, e.smooth, e.smoothMonotone) + 1
                }
            }),
            Polygon: a.extend({
                type: "ec-polygon",
                ...
                buildPath: function(t, e) {
                    for (var i = e.points, a = e.stackedOnPoints, r = 0, s = i.length, l = e.smoothMonotone, h = o(i, e.smoothConstraint), u = o(a, e.smoothConstraint); s > r; ) {
                        ...
                        n(t, a, r + c - 1, s, c, -1, u.min, u.max, e.stackedOnSmooth, l),
                        r += c + 1,
                        t.closePath()
                    }
                }
    ...
    , function(t, e, i) {
        ...
        o.registerVisualCoding("chart", n.curry(i(63), "pie")),
        o.registerLayout(n.curry(i(94), "pie")),
        o.registerProcessor("filter", n.curry(i(62), "pie"))
    }
    , function(t, e, i) {
        "use strict";
        var n = i(14)
    ...
    , function(t, e, i) {
        ...
        h.updateData = function(t, e, i) {
            ...
            o(this, t.getItemLayout(e), u.get("selected"), h.get("selectedOffset"), h.get("animation")),
            r.off("mouseover").off("mouseout").off("emphasis").off("normal"),
            u.get("hoverAnimation") && r.on("mouseover", n).on("mouseout", a).on("emphasis", n).on("normal", a),
          ...
          , c = i(2).extendComponentView({
            ...
            _splitLine: function(t, e, i) {
                ...
                for (var f = e.coordinateSystem.getRect(), p = n.isHorizontal(), g = [], m = 0, v = n.getTicksCoords(), y = [], x = [], _ = 0; _ < v.length; _++)
                    if (!s(n, _, d)) {
                        ...
                        var b = m++ % c.length;
                        g[b] = g[b] || [],
                        g[b].push(new a.Line(a.subPixelOptimizeLine({
                            shape: {
                                x1: y[0],
                                y1: y[1],
                                x2: x[0],
                ...
                for (var M = h.getLineStyle(), _ = 0; _ < g.length; _++)
                    this.group.add(a.mergePath(g[_], {
                        style: o.defaults({
                            stroke: c[_ % c.length]
                        }, M),
                        silent: !0
            ...
            _splitArea: function(t, e, i) {
                ...
                for (var A = h.getAreaStyle(), y = 0; y < g.length; y++)
                    this.group.add(a.mergePath(g[y], {
                        style: o.defaults({
                            fill: u[y % u.length]
                        }, A),
                        silent: !0
    ...
    , function(t, e, i) {
        ...
        r.prototype = {
            ...
            getLabelInterval: function() {
                ...
                return t || (t = this._labelInterval = a(this)),
                t
            },
    ...
    , function(t, e, i) {
        ...
        function r(t, e) {
            ...
            p(e, function(e, n) {
                var o = e.option;
                if (c.assert(!o || null  == o.id || !i[o.id] || i[o.id] === e, "id duplicates: " + (o && o.id)),
            ...
            p(e, function(t, e) {
                var n = t.exist
                  ...
                  , a = t.keyInfo;
                if (x(o)) {
                    if (a.name = null  != o.name ? o.name + "" : n ? n.name : "\x00-",
                    n)
                        a.id = n.id;
                    else if (null  != o.id)
                        a.id = o.id + "";
          ...
          , M = f.extend({
            ...
            resetOption: function(t) {
                ...
                if (!t || "recreate" === t) {
                    ...
                    this.mergeOption(n)) : o.call(this, n),
                    e = !0
                }
            ...
            mergeOption: function(t) {
                function e(e, o) {
                    ...
                    p(h, function(t, o) {
                        var a = t.exist
                          , r = t.option;
                        if (c.assert(x(r) || a, "Empty component definition"),
                        r) {
                            var s = _.getClass(e, t.keyInfo.subType, !0);
                            a && a instanceof s ? (a.mergeOption(r, this),
                            a.optionUpdated(this)) : (a = new s(r,this,this,c.extend({
                                dependentModels: u,
                                componentIndex: o
                            }, t.keyInfo)),
    ...
    , function(t, e, i) {
        ...
        function o(t, e) {
            ...
            d([n].concat(o).concat(h.map(a, function(t) {
                return t.option
            }
            )), function(t) {
                d(e, function(e) {
        ...
        t.exports = function(t) {
            if (t) {
                ...
                if (e) {
                    ...
                    var a = t.markPoint;
                    if (a && a.data)
                        for (var r = a.data, i = 0; i < r.length; i++)
                            n(r[i]);
                    var s = t.markLine;
                    if (s && s.data)
                        for (var l = s.data, i = 0; i < l.length; i++)
                            o.isArray(l[i]) ? (n(l[i][0]),
                            n(l[i][1])) : n(l[i])
                }
            }
        }
        ...
        i.throttle = function(t, e, i, n) {
            function o(o) {
                ...
                var p = function() {
                    ...
                    a = l - (n ? h : u) - e,
                    clearTimeout(c),
                    n ? i ? c = setTimeout(f, e) : a >= 0 && f() : a >= 0 ? f() : i && (c = setTimeout(f, -a)),
                    h = l
                }
                ;
    ...
    , function(t, e, i) {
        ...
        function o(t, e, i) {
            ...
            o) {
                var a = o.type;
                e.gestureEvent = a,
                t._dispatchProxy(o.target, a, o.event)
            }
        }
        function a(t) {
            function e(t, e) {
        ...
        A.prototype = {
            ...
            _dispatchProxy: function(t, e, i) {
                for (var o = "on" + e, a = n(e, t, i), r = t; r && (r[o] && (a.cancelBubble = r[o].call(r, a)),
                r.trigger(e, a),
                r = r.parent,
                !a.cancelBubble); )
                    ;
    ...
    , function(t, e, i) {
        ...
        var a = i(1)
          ...
          , s = function(t, e, i) {
            ...
            "string" == typeof t ? s = o(t, "canvas", e, i) : a.isObject(t) && (s = t,
            t = s.id),
            this.id = t,
            this.dom = s;
            var l = s.style;
    ...
    , function(t, e, i) {
        ...
        var u = i(42)
          ...
          , v = function(t, e, i) {
            ...
            this.root = t;
            var o = t.style;
            if (o && (o["-webkit-tap-highlight-color"] = "transparent",
    ...
    , function(t, e, i) {
        ...
        r.prototype = {
            ...
            updateDisplayList: function(t) {
                this._displayListLen = 0;
                for (var e = this._roots, i = this._displayList, o = 0, a = e.length; a > o; o++)
            ...
            addRoot: function(t) {
                this._elements[t.id] || (t instanceof a && t.addChildrenToStorage(this),
                this.addToMap(t),
                this._roots.push(t))
            },
            delRoot: function(t) {
            ...
            delFromMap: function(t) {
                var e = this._elements
                  , i = e[t];
                return i && (delete e[t],
                i instanceof a && (i.__storage = null )),
                this
            },
            dispose: function() {
        ...
        t.exports = {
            containStroke: function(t, e, i, o, a, r, s, l, h, u, c) {
                if (0 === h)
                    return !1;
                var d = h;
                if (c > e + d && c > o + d && c > r + d && c > l + d || e - d > c && o - d > c && r - d > c && l - d > c || u > t + d && u > i + d && u > a + d && u > s + d || t - d > u && i - d > u && a - d > u && s - d > u)
                    return !1;
        ...
        t.exports = {
            containStroke: function(t, e, i, n, o, a, r) {
                ...
                var s = o
                  , l = 0
                  , h = t;
                if (r > e + s && r > n + s || e - s > r && n - s > r || a > t + s && a > i + s || t - s > a && i - s > a)
                    return !1;
                if (t === i)
    ...
    , function(t, e, i) {
            ...
            for (var c = 0, d = 0; 2 > d; d++) {
                ...
                if (f + t > r) {
                    var g = Math.atan2(s, f)
                      , u = a ? 1 : -1;
                    0 > g && (g = y + g),
                    (g >= n && o >= g || g + y >= n && o >= g + y) && (g > Math.PI / 2 && g < 1.5 * Math.PI && (u = -u),
                    c += u)
                }
            }
            return c
        ...
        function l(t, e, i, o, l) {
            for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length; ) {
                var w = t[_++];
                if (w === h.M && _ > 1 && (i || (u += m(p, g, y, x, o, l)),
                0 !== u))
                    return !0;
                switch (1 == _ && (p = t[_],
                g = t[_ + 1],
                ...
                case h.Q:
                    if (i) {
                        ...
                        u += r(p, g, t[_++], t[_++], t[_], t[_ + 1], o, l) || 0;
                    p = t[_++],
                    g = t[_++];
                    break;
                case h.A:
                ...
                case h.R:
                    ...
                    var k = t[_++]
                      ...
                      , D = x + z;
                    if (i) {
                        if (v(y, x, L, x, e, o, l) || v(L, x, L, D, e, o, l) || v(L, D, y, D, e, o, l) || v(y, D, L, D, e, o, l))
                            return !0
                    } else
                        u += m(L, x, L, D, o, l),
                        u += m(y, D, y, x, o, l);
            ...
            return i || n(g, x) || (u += m(p, g, y, x, o, l) || 0),
            0 !== u
        }
        var h = i(27).CMD
          , u = i(136)
        ...
        t.exports = {
            containStroke: function(t, e, i, o, a, r, s, l, h) {
                if (0 === s)
                    return !1;
                var u = s;
                if (h > e + u && h > o + u && h > r + u || e - u > h && o - u > h && r - u > h || l > t + u && l > i + u && l > a + u || t - u > l && i - u > l && a - u > l)
                    return !1;
    ...
    , function(t, e, i) {
        ...
        a.prototype = {
            ...
            type: "radial",
            updateCanvasGradient: function(t, e) {
                for (var i = t.getBoundingRect(), n = i.width, o = i.height, a = Math.min(n, o), r = this.x * n + i.x, s = this.y * o + i.y, l = this.r * a, h = e.createRadialGradient(r, s, 0, r, s, l), u = this.colorStops, c = 0; c < u.length; c++)
    ...
    , function(t, e) {
        ...
        n.prototype = {
            ...
            bind: function(t, e) {
                ...
                null  != o && (t.strokeStyle = o.canvasGradient ? o.canvasGradient : o),
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function(t, e) {
                var i = e.x1
                  ...
                  , f = e.percent;
                0 !== f && (t.moveTo(i, n),
                null  == c || null  == d ? (1 > f && (o(i, h, r, f, l),
                h = l[1],
                r = l[2],
                o(n, u, s, f, l),
                u = l[1],
                s = l[2]),
                t.quadraticCurveTo(h, u, r, s)) : (1 > f && (a(i, h, c, r, f, l),
                h = l[1],
                c = l[2],
                r = l[3],
                a(n, u, d, s, f, l),
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function(t, e) {
                var i = e.x
                  ...
                  , a = e.width
                  , r = e.height;
                e.r ? n.buildPath(t, e) : t.rect(i, o, a, r),
                t.closePath()
            }
        })
    }
    ...
    , function(t, e, i) {
        ...
        h.prototype = {
            ...
            _animateToShallow: function(t, e, i, n, a) {
                ...
                for (var h in i)
                    if (null  != e[h])
                        s(i[h]) && !o.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, a) : (r[h] = i[h],
                        l++);
                    else if (null  != i[h])
                        if (t) {
                            var u = {};
                            ...
                            this.attr(h, i[h]);
                return l > 0 && this.animate(t, !1).when(null  == n ? 500 : n, r).delay(a || 0),
                this
            }
        },
        t.exports = h
    ...
    , function(t, e, i) {
        ...
        function s(t) {
            if (!(this._disabled || t.target && t.target.draggable)) {
                ...
                var e = t.offsetX
                  , i = t.offsetY;
                a.call(this, e, i) && (this._dragging = !0,
                this._track = [[e, i]])
            }
        }
        function l(t) {
    ...
    , function(t, e, i) {
        ...
        function o(t, e, i) {
            ...
            h([0, 1], function(t) {
                ...
                i = o.parse(l.linearMap(n, r, e, !0))) : n = l.linearMap(i, e, r, !0),
                c[t] = l.round(i),
                s[t] = l.round(n)
            }
            ),
    ...
    , function(t, e, i) {
        ...
        function a(t, e, i) {
            ...
            a.pixelStart = o.x,
            a.signal = n.inverse ? 1 : -1) : (a.pixel = t[1],
        ...
        var s = i(40)
          ...
          , d = s.extend({
            ...
            render: function(t, e, i, n) {
                ...
                l.each(this.getTargetInfo().cartesians, function(e) {
                    var n = e.model;
                    u.register(i, {
                        coordId: n.id,
                        coordType: n.type,
        ...
        var o = i(1)
          ...
          , A = s.extend({
            ...
            _formatLabel: function(t, e) {
                ...
                t = null  == t && isNaN(t) ? "" : "category" === e.type || "time" === e.type ? e.scale.getLabel(Math.round(t)) : t.toFixed(Math.min(a, 20)),
                ...
                t.get("show")) {
                    ...
                    r.each(t.getData(), function(r) {
                        ...
                        g && !p[h]) {
                            ...
                            _.on("click", u(n, h, i)).on("mouseover", u(o, g, "", i)).on("mouseout", u(a, g, "", i)),
                            p[h] = !0
                        }
                    }
                    , this),
                        ...
                        if (e.legendDataProvider) {
                            ...
                            r.each(function(s) {
                                ...
                                if (f[l] && !p[l]) {
                                    ...
                                    m.on("click", u(n, l, i)).on("mouseover", u(o, e, l, i)).on("mouseout", u(a, e, l, i)),
                                    p[l] = !0
                                }
                            }
                            , !1, this)
    ...
    , function(t, e, i) {
        ...
        function o(t, e, i) {
            ...
            l.initData(a.map(u, function(t) {
                return t[1]
            }
            ), null , c),
            h.initData(a.map(u, function(t) {
                return t[2]
            }
            )),
            {
        ...
        var a = i(1)
          ...
          , p = function(t, e, i, n) {
            ...
            return n = [d.dataTransform(t, n[0]), d.dataTransform(t, n[1]), a.extend({}, n[2])],
            n[2].type = n[2].type || "",
            a.merge(n[2], n[0]),
            a.merge(n[2], n[1]),
            n
        ...
        a.defaults(g, l.dataFormatMixin),
        i(2).extendComponentView({
            type: "markLine",
            init: function() {
                this._markLineMap = {}
            ...
            render: function(t, e, i) {
                ...
                , this);
                for (var o in n)
                    n[o].__keep || this.group.remove(n[o].group)
            },
            _renderSeriesML: function(t, e, i, n) {
                function r(e, i, o, a, r) {
                    var l, c = e.getItemModel(i), d = c.get("x"), f = c.get("y");
                    if (null  != d && null  != f)
                        l = [h.parsePercent(d, n.getWidth()), h.parsePercent(f, n.getHeight())];
                    else {
                        if (t.getMarkerPosition)
                            l = t.getMarkerPosition(e.getValues(e.dimensions, i));
                        else {
                            var p = s.dimensions
                              , g = e.get(p[0], i)
                              , m = e.get(p[1], i);
                ...
                d.updateData(y, m, v),
                p.line.eachItemGraphicEl(function(t, i) {
                    t.traverse(function(t) {
    ...
    , function(t, e, i) {
        function n(t, e, i) {
            ...
            return t && (r = a.filter(r, a.curry(d.dataFilter, t))),
            o.initData(r, null , t ? d.dimValueGetter : function(t) {
                return t.value
            }
            ),
            o
        ...
        a.defaults(f, s.dataFormatMixin),
        i(2).extendComponentView({
            type: "markPoint",
            init: function() {
                this._symbolDrawMap = {}
            ...
            render: function(t, e, i) {
                ...
                , this);
                for (var o in n)
                    n[o].__keep || (n[o].remove(),
                    this.group.remove(n[o].group))
            },
            _renderSeriesMP: function(t, e, i) {
                ...
                d.each(function(n) {
                    ...
                    if (null  != s && null  != u)
                        o = [l.parsePercent(s, i.getWidth()), l.parsePercent(u, i.getHeight())];
                    else if (t.getMarkerPosition)
                        o = t.getMarkerPosition(d.getValues(d.dimensions, n));
                    else if (r) {
                        var c = d.get(p[0], n)
                          , f = d.get(p[1], n);
                        o = r.dataToPoint([c, f])
                    ...
                    "function" == typeof g && (g = g(e.getRawValue(n), e.getDataParams(n))),
                    d.setItemVisual(n, {
                        symbolSize: g,
            ...
            t.exports = i(2).extendComponentView({
                ...
                render: function(t, e, i) {
                    ...
                    t.get("show")) {
                        ...
                        new l(this._featureNames || [],v).add(c).update(c).remove(a.curry(c, null )).execute(),
                        ...
                        f.eachChild(function(t) {
                            ...
                            if (n && e) {
                                var o = u.getBoundingRect(e, n.font)
                                  ...
                                  , s = !1;
                                r + o.height > i.getHeight() && (n.textPosition = "top",
                                s = !0);
                                var l = s ? -5 - o.height : p + 8;
                                a + o.width / 2 > i.getWidth() ? (n.textPosition = ["100%", l],
                                n.textAlign = "right") : a - o.width / 2 < 0 && (n.textPosition = [0, l],
                                n.textAlign = "left")
                            }
                        }
                        )
    ...
    , function(t, e, i) {
        ...
        function a(t) {
            return p.map(t, function(t) {
                ...
                return e.each(e.dimensions, function() {
                    for (var t = arguments.length, o = arguments[t - 1], a = e.getName(o), r = 0; t - 1 > r; r++)
                        n[r] = arguments[r];
        ...
        d.prototype.onclick = function(t, e) {
            ...
            h.style.cssText = "display:block;width:100%;font-size:14px;line-height:1.6rem;font-family:Monaco,Consolas,Courier new,monospace",
            ...
            p += ";background-color:" + o.get("buttonColor"),
            p += ";color:" + o.get("buttonTextColor");
            var x = this;
            g.addEventListener(m, "click", i),
            g.addEventListener(y, "click", function() {
                var t;
                try {
                    t = c(h.value, d)
                } catch (n) {
    ...
    , function(t, e, i) {
        ...
        var _ = {
            zoom: function(t, e, i, n) {
                ...
                o ? (a.setDefaultCursorStyle("crosshair"),
    ...
    , function(t, e, i) {
        ...
        function a(t) {
            ...
            var e = []
              ...
              , s = t.get("padding");
            return i && e.push(n(i)),
            a && (e.push("background-Color:" + h.toHex(a)),
        ...
        function r(t, e) {
            ...
            i.onmouseenter = function() {
                o.enterable && (clearTimeout(o._hideTimeout),
                o._show = !0),
                o._inContent = !0
            }
            ,
        ...
        r.prototype = {
            ...
            show: function(t) {
                ...
                this.el.style.cssText = g + a(t) + ";left:" + this._x + "px;top:" + this._y + "px;" + (t.get("extraCssText") || ""),
                this._show = !0
            },
    ...
    , function(t, e, i) {
        ...
        function h(t, e, i, n, o, a, r) {
            ...
            if (a && c.applyTransform(a.transform),
            "function" == typeof t && (t = t([e, i], o, c)),
            f.isArray(t))
                e = m(t[0], h),
                i = m(t[1], u);
        ...
        i(2).extendComponentView({
            ...
            _prepareAxisTriggerData: function(t, e) {
                ...
                return e.eachSeries(function(t) {
                    if (u(t)) {
                        ...
                        "cartesian2d" === o.type ? (e = o.getBaseAxis(),
                        n = e.dim + e.index) : "single" === o.type ? (e = o.getAxis(),
                        n = e.dim + e.type) : (e = o.getBaseAxis(),
                        n = e.dim + o.name),
                        i[n] = i[n] || {
                            coordSys: [],
                            series: []
            ...
            _tryShow: function(t) {
                ...
                if (i)
                    ...
                    e && null  != e.dataIndex) {
                        ...
                        "axis" === (l.get("tooltip.trigger") || n) ? this._showAxisTooltip(i, o, t) : (this._ticket = "",
                        ...
                        "cross" === i.get("axisPointer.type") && a.dispatchAction({
                            type: "showTip",
                            from: this.uid,
                            x: t.offsetX,
                            y: t.offsetY
            ...
            _showAxisTooltip: function(t, e, i) {
                ...
                f.each(this._seriesGroupByAxis, function(t) {
                    ...
                    "cartesian2d" !== r.type || p ? "polar" !== r.type || p ? "single" !== r.type || p || this._showSinglePointer(o, r, d, s) : this._showPolarPointer(o, r, d, s) : this._showCartesianPointer(o, r, d, s),
                    "cross" !== a && this._dispatchAndShowSeriesTooltipContent(r, t.series, s, u, p)
                }
                , this),
                h && this._hide()
            },
        ...
        if (!i(15).canvasSupported) {
            var n = i(5)
              ...
              , B = function(t, e, i, n) {
                ...
                a || (a = p.createNode(e)),
                o ? V(a, i, n) : N(a, i),
                P(t, a)) : (t[o ? "filled" : "stroked"] = "false",
                k(t, a))
            }
              , G = [[], [], []]
              , F = function(t, e) {
            ...
            u.prototype.brushVML = function(t) {
                ...
                if (o) {
                    ...
                    X += M + ".AlphaImageLoader(src=" + o + ", SizingMethod=scale)",
                    Z.filter = X,
        ...
        t.exports = function(t) {
            ...
            if (!e || "view" === e.type) {
                ...
                i.eachEdge(function(t) {
                    var e, i = t.getModel().get("lineStyle.normal.curveness") || 0, n = t.node1.getLayout(), o = t.node2.getLayout();
                    i > 0 && (e = [(n[0] + o[0]) / 2 - (n[1] - o[1]) * i, (n[1] + o[1]) / 2 - (o[0] - n[0]) * i]),
                    t.setLayout([n, o, e])
                }
                )
            }
    ...
    , function(t, e, i) {
        var n = i(14)
          ...
          , s = i(1);
        t.exports = function(t, e, i, l) {
            for (var h = new o(l), u = 0; u < t.length; u++)
    ...
    , function(t, e, i) {
        var n = i(1)
          ...
          , m = a.extendComponentModel({
            ...
            mergeOption: function(t) {
                m.superApply(this, "mergeOption", arguments),
            ...
            formatValueText: function(t, e) {
                ...
                return n.isArray(t) && (t = t.slice(),
                o = !0),
                a = e ? t : o ? [i(t[0]), i(t[1])] : i(t),
                n.isString(h) ? h.replace("{value}", o ? a[0] : a).replace("{value2}", o ? a[1] : a) : n.isFunction(h) ? o ? h(t[0], t[1]) : h(t) : o ? t[0] === l[0] ? "< " + a[1] : t[1] === l[1] ? "> " + a[0] : a[0] + " - " + a[1] : a
            },
            ...
            completeVisualOption: function() {
                ...
                function i(t) {
                    ...
                    f(this.stateList, function(a) {
                        ...
                        s.symbol || (s.symbol = e && n.clone(e) || (p ? "roundRect" : ["roundRect"])),
                        s.symbolSize || (s.symbolSize = i && n.clone(i) || (p ? r[0] : [r[0], r[0]])),
                        s.symbol = h(s.symbol, function(t) {
          ...
          , o = {
            getItemAlign: function(t, e, i) {
                ...
                for (var r = {
                    width: e.getWidth(),
                    height: e.getHeight()
                }, s = "horizontal" === o.orient ? 1 : 0, l = [["left", "right", "width"], ["top", "bottom", "height"]], h = l[s], u = [0, null , 10], c = {}, d = 0; 3 > d; d++)
                    c[l[1 - s][d]] = u[d],
                    c[h[d]] = 2 === d ? i[0] : o[h[d]];
            ...
            a(e, function(t) {
                if (t) {
                    ...
                    e && o.isArray(e) && a(e, function(t) {
                        o.isObject(t) && (n(t, "start") && !n(t, "min") && (t.min = t.start),
    ...
    , function(t, e, i) {
        ...
        n.prototype = {
            ...
            getBoundingRect: function() {
                ...
                if (t)
                    return t;
                for (var e = Number.MAX_VALUE, i = [e, e], n = [-e, -e], o = [], l = [], h = this.contours, u = 0; u < h.length; u++)
                    r.fromPoints(h[u], o, l),
                    s.min(i, i, o),
                    s.max(n, n, l);
    ...
    , function(t, e, i) {
        ...
        n.mixin(r, a.seriesModelMixin, !0),
        t.exports = r
    }
    , function(t, e, i) {
        "use strict";
        ...
        function a(t, e, i) {
            ...
            o.each(a, function() {
                function t(t) {
                    ...
                    i[p] = t;
                    var o;
                    return isNaN(c) || isNaN(t) ? o = [NaN, NaN] : (o = n.dataToPoint(i),
                    o[f] += e),
                    o
                }
                function i(t, e) {
    ...
    , function(t, e, i) {
        ...
        n.mixin(h, a.seriesModelMixin, !0),
        t.exports = h
    }
    , function(t, e, i) {
        "use strict";
    ...
    , function(t, e, i) {
        ...
        i(239),
        i(240),
        o.registerVisualCoding("chart", n.curry(i(63), "funnel")),
        o.registerLayout(i(241)),
        o.registerProcessor("filter", n.curry(i(62), "funnel"))
    }
    , function(t, e, i) {
        "use strict";
        var n = i(14)
    ...
    , function(t, e, i) {
        ...
        function o(t, e) {
            ...
            ), n = [], o = "ascending" === e, a = 0, r = t.count(); r > a; a++)
                n[a] = a;
        ...
        var a = i(245)
          ...
          , u = i(25).extend({
            ...
            _renderMain: function(t, e, i, n, o) {
                ...
                this._renderTicks(t, e, i, y, o, c, d, u),
                this._renderPointer(t, e, i, y, o, c, d, u),
        ...
        t.exports = function(t, e, i) {
            ...
            return {
                ...
                step: function(i) {
                    ...
                    for (var s = 0; r > s; s++) {
                        var m = t[s];
                        m.fixed || (n.sub(a, l, m.p),
                        n.scaleAndAdd(m.p, m.p, a, h * d))
                    }
                    for (var s = 0; r > s; s++)
                        for (var c = t[s], v = s + 1; r > v; v++) {
                            ...
                            n.sub(a, f.p, c.p);
                            var p = n.len(a);
                            0 === p && (n.set(a, Math.random() - .5, Math.random() - .5),
                            p = 1);
    ...
    , function(t, e, i) {
        ...
        n.prototype = {
            ...
            _getGradient: function(t, e, i) {
                for (var n = this._gradientPixels, o = n[i] || (n[i] = new Uint8ClampedArray(1024)), a = [], r = 0, s = 0; 256 > s; s++)
                    e[i](s / 255, !0, a),
                    o[r++] = a[0],
                    o[r++] = a[1],
                    o[r++] = a[2],
    ...
    , function(t, e, i) {
        ...
        c._updateEffectSymbol = function(t, e) {
            ...
            c.animate("", !0).when(d, {
                __t: 1
            }).delay(e / t.count() * d / 2).during(l.bind(a, c)).start()),
    ...
    , function(t, e, i) {
        ...
        d.updateData = function(t) {
            ...
            t.diff(i).add(function(i) {
                ...
                return t.hasValue(a) ? (s ? s.updateData(t, a) : s = new n(t,a,o),
                e.add(s),
                void t.setItemGraphicEl(a, s)) : void e.remove(s)
            }
            ).remove(function(t) {
        ...
        t.exports = n.extend({
            ...
            getInitialData: function(t, e) {
                ...
                a.each(t.data, function(t) {
                    n.push(t[0]),
                    s.push(t[1]),
                    l.push(a.extend(a.extend({}, a.isArray(t[0]) ? null  : t[0]), a.isArray(t[1]) ? null  : t[1]))
                }
                );
        ...
        t.exports = function(t) {
            t.eachSeriesByType("lines", function(t) {
                ...
                o.each(function(t) {
                    ...
                    s > 0 && (e = [(a[0] + r[0]) / 2 - (a[1] - r[1]) * s, (a[1] + r[1]) / 2 - (r[0] - a[0]) * s]),
    ...
    , function(t, e, i) {
        function n(t, e) {
            for (var i = {}, n = e.features, o = 0; o < t.length; o++)
                i[t[o].name] = t[o];
            for (var o = 0; o < n.length; o++) {
        ...
        var o = i(14)
          ...
          , f = r.extend({
            ...
            formatTooltip: function(t) {
                for (var e = this._data, i = c(this.getRawValue(t)), n = e.getName(t), o = this.seriesGroup, a = [], r = 0; r < o.length; r++)
                    isNaN(o[r].getRawValue(t)) || a.push(u(o[r].name));
    ...
    , function(t, e, i) {
        function n(t, e) {
            ...
            return t[0].map(n, function(n, o) {
                for (var a = t[0].getName(o), r = 0, s = 1 / 0, l = -(1 / 0), h = i[a].length, u = 0; h > u; u++)
                    s = Math.min(s, i[a][u]),
                    l = Math.max(l, i[a][u]),
                    r += i[a][u];
                var c;
    ...
    , function(t, e, i) {
        ...
        i(280),
        i(281),
        o.registerVisualCoding("chart", n.curry(i(63), "radar")),
        o.registerVisualCoding("chart", n.curry(i(44), "radar", "circle", null )),
        o.registerLayout(i(283)),
        o.registerProcessor("filter", n.curry(i(62), "radar")),
        o.registerPreprocessor(i(282))
    }
    , function(t, e, i) {
        "use strict";
        var n = i(13)
        ...
        t.exports = i(2).extendChartView({
            ...
            render: function(t, e, i) {
                ...
                d.diff(f).add(function(e) {
                    ...
                    h.shape.points && (l(a.shape.points, h.shape.points, s, d, e, !1),
                    o.updateProps(a, h, t),
                    o.updateProps(r, h, t),
                ...
                d.eachItemGraphicEl(function(e, i) {
                    ...
                    c.add(e),
                    l.setStyle(a.extend(s.getModel("lineStyle.normal").getLineStyle(), {
                        stroke: f
                    })),
                    ...
                    v = v && m,
                    h.ignore = m,
                    h.setStyle(a.defaults(p.getAreaStyle(), {
                        fill: f,
                        opacity: .7
                    })),
                    ...
                    u.eachChild(function(e) {
                        ...
                        o.setText(e.hoverStyle, w, f),
                        e.hoverStyle.text = w.get("show") ? a.retrieve(t.getFormattedLabel(i, "emphasis", null , e.__dimIdx), n) : ""
                    }
                    ),
        ...
        t.exports = i(2).extendChartView({
            ...
            render: function(t, e, i) {
                ...
                l.eachNode(function(e) {
                    ...
                    o.setHoverStyle(c, r.extend(e.getModel("itemStyle.emphasis"), {
                ...
                l.eachEdge(function(t) {
                    ...
                    o.setHoverStyle(e, t.getModel("lineStyle.emphasis").getItemStyle()),
                    h.add(e)
                }
                ),
    ...
    , function(t, e, i) {
        ...
        function o(t, e, i, n, o, a) {
            ...
            return !a && r.splice(2, 0, [t + i + u, e + n / 2]),
            !o && r.push([t, e + n / 2]),
            r
        }
        var a = i(3)
                ...
                if (i.get("animation")) {
                    ...
                    m(this._storage, function(t, i) {
                        m(t, function(t, n) {
                            ...
                            t.position = l.old) : (l.old && (h.shape = o.extend({}, t.shape),
                            t.setShape(l.old)),
    ...
    , function(t, e, i) {
        function n(t, e, i) {
            ...
            t.eachComponent(n, function(t) {
                ...
                t.setLayoutInfo(u),
                f(t.getData().tree.root, new b(-u.x,-u.y,n,a), x.getPathToRoot(v))
            }
            )
        }
        function o(t, e, i, n) {
        ...
        i(2).extendComponentView({
            ...
            _splitLine: function(t, e, i, r) {
                ...
                for (var d = 0; d < c.length; d++)
                    this.group.add(a.mergePath(c[d], {
                        style: o.defaults({
                            stroke: h[d % h.length]
                        }, l.getLineStyle()),
                        silent: !0,
        ...
        i(2).extendComponentView({
            ...
            _splitArea: function(t, e, i, n, r) {
                ...
                for (var f = 0; f < c.length; f++)
                    this.group.add(a.mergePath(c[f], {
                        style: o.defaults({
                            fill: h[f % h.length]
                        }, l.getAreaStyle()),
                        silent: !0
    ...
    , function(t, e, i) {
        ...
        function a(t, e, i, n, o, a) {
            ...
            return o ? (o.setStyle(c),
            o.setColor(l),
            i.add(o),
            a && a.onUpdate(o)) : (o = d.createSymbol(r, -u, -u, h, h, l),
            i.add(o),
            a && a.onCreate(o)),
            n = s.merge({
                rectHover: !0,
        ...
        t.exports = u.extend({
            ...
            _renderAxisTick: function(t, e, i, n) {
                ...
                w(r, function(t, n) {
                    ...
                    f.hostModel = s) : f.dataIndex = f.hostModel = null 
                }
                , this)
            },
            ...
            _renderControl: function(t, e, i, n) {
                ...
                var r = t.controlSize
                  ...
                  , d = n.getPlayState()
                  , f = n.get("inverse", !0);
                a(t.nextBtnPosition, "controlStyle.nextIcon", _(this._changeTimeline, this, f ? "-" : "+")),
                a(t.prevBtnPosition, "controlStyle.prevIcon", _(this._changeTimeline, this, f ? "+" : "-")),
                a(t.playPosition, "controlStyle." + (d ? "stopIcon" : "playIcon"), _(this._handlePlayClick, this, !d), !0)
            },
    ...
    , function(t, e, i) {
        ...
        r.prototype = {
            ...
            getLabelInterval: function() {
                ...
                return i || (i = this._autoLabelInterval = a.getAxisLabelInterval(n.map(this.scale.getTicks(), this.dataToCoord, this), a.getFormattedLabels(this, e.get("formatter")), e.getModel("textStyle").getFont(), "horizontal" === t.get("orient"))),
                i
            },
            isLabelIgnored: function(t) {
                if ("category" === this.type) {
    ...
    , function(t, e, i) {
        function n(t) {
            ...
            a(t, "controlPosition")) {
                ...
                "none" !== n.position || a(n, "show") || (n.show = !1,
                delete n.position),
                delete t.controlPosition
            }
            r.each(t.data || [], function(t) {
                r.isObject(t) && !r.isArray(t) && (!a(t, "value") && a(t, "name") && (t.value = t.name),
                o(t))
            }
            )
        }
        function o(t) {
            ...
            i.label && !a(n, "emphasis") && (n.emphasis = i.label,
            delete i.label)
        }
        function a(t, e) {
            return t.hasOwnProperty(e)
        ...
        var n = i(212)
          ...
          , s = n.extend({
            ...
            completeVisualOption: function() {
                ...
                o.each(this.stateList, function(t) {
        ...
        var a = i(213)
          ...
          , p = a.extend({
            ...
            _renderBar: function(t) {
                ...
                i.handleLabels = [],
                i.handleLabelPoints = [],
                this._createHandle(h, 0, o, c, a, l),
                this._createHandle(h, 1, o, c, a, l)),
                t.add(h)
            },
        ...
        var o = i(212)
          ...
          , s = o.extend({
            ...
            doMergeOption: function(t, e) {
                ...
                this.resetVisual(function(t, e) {
                    ...
                    t.categories = a.clone(n)) : (t.mappingMethod = "piecewise",
          ...
          , l = {
            splitNumber: function() {
                ...
                t.splitNumber = n;
                for (var o = (i[1] - i[0]) / n; +o.toFixed(e) !== o && 5 > e; )
                    e++;
                t.precision = e,
                o = +o.toFixed(e);
                for (var a = 0, r = i[0]; n > a; a++,
                r += o) {
                    var s = a === n - 1 ? i[1] : r + o;
        ...
        var n = i(213)
          ...
          , h = n.extend({
            ...
            doRender: function() {
                function t(t) {
                    var i = new a.Group;
                    i.onclick = o.bind(this._onItemClick, this, t.piece),
        ...
        t.exports = function(t) {
            ...
            r.map(r.filter(t.features, function(t) {
                ...
                var e = t.properties
                  , i = t.geometry
                  , n = i.coordinates;
                return "MultiPolygon" === i.type && (n = a(n)),
                new s(e.name,n,e.cp)
            }
            )
        }
    ...
    , function(t, e, i) {
        ...
        n.prototype = {
            ...
            eachActiveState: function(t, e, i) {
                for (var n = this.dimensions, o = this._axesMap, a = !1, r = 0, s = n.length; s > r; r++)
    ...
    , function(t, e, i) {
        ...
        a.prototype = {
            ...
            pointToCoord: function(t) {
                ...
                e /= s,
                i /= s;
                for (var l = Math.atan2(-i, e) / Math.PI * 180, h = a > l ? 1 : -1; a > l || l > r; )
                    l += 360 * h;
                return [s, l]
            },
    ...
    , function(t, e, i) {
        function n(t, e, i) {
            this._model = t,
            this.dimensions = [],
            this._indicatorAxes = o.map(t.getIndicatorModels(), function(t, e) {
                var i = "indicator_" + e
                  , n = new a(i,new r);
        ...
        n.prototype.resize = function(t, e) {
            ...
            o.each(this._indicatorAxes, function(t, e) {
    ...
    , function(t, e, i) {
        ...
        ,
        s.update = function() {
            for (var t = this.data, e = this.edgeData, i = this.nodes, n = this.edges, o = 0, a = i.length; a > o; o++)
                i[o].dataIndex = -1;
    ...
    , function(t, e, i) {
        ...
        function o(t, e, i) {
            ...
            var h = t[0];
            return n(r[0], h[0]) && n(r[1], h[1]) || (o += a(r[0], r[1], h[0], h[1], e, i)),
            0 !== o
        }
        var a = i(75)
          , r = 1e-8;
